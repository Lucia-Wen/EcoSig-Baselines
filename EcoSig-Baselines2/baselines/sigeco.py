...
# max_dist= 500      #4e3    #1200   #2e3    #5400   | 500
# max_interval=300    #1500   #500    #-      #1500   |   -
# reward_step = 0.2
#
...
# Pass_reward=max_step*dt/5   #200/400
...
#             self.GreenStop += 1
#             print("green stop ",self.GreenStop)
#         else:
#             self.GreenStop = 0
#
...
#         if mod =="dim3":
#             reward = self.reward_Red - reward_step + self.reward_Pass + self.reward_End + self.reward_Green_Stop + self.reward_red_far
#         if mod =="dim5":
...
max_step = 1e3      #2e3    #1e3    #5e3    #3e3    | 1e3
max_dist= 5400      #4e3    #1200   #2e3    #5400   | 500
...
class SigEcoEnv(gym.Env):
    ...
    def _get_reward(self):
        ...
        if bool(self.GreenStop>=10):
            self.reward_Green_Stop = -GStop_reward
        if self.RedFar:
            self.reward_red_far = -RedFar_reward*1#(0.5+self.state[1]/max_interval)
            print("red_far:", self.state[1])
        if self.EndFlag:
            self.reward_End = End_reward
        if mod =="dim3":
